...
<head>
    ...
    transition: .25s;
     ...
     #rooms button[type="submit"],select{
    margin: 20px auto;
            ...
            <div class="row">
                <div class="col-md-3" style="  height: 500px;">
                    <div class="list-group" style="margin-top: 50px;">
                        ...
                        <button class="list-group-item list-group-item-action" onclick="changemapfaculty();">Change Faculty mapping</button>
...
//                                            echo $year." ".$yearsnew[$j][$count2]." - ".$yearsnew[$j][$next];
                        ...
                        <div id="rooms">
                            <script>
                               ...
                               v += "</br><label>capacity" + i + "</label><input type='text' id='texte' name='texte" + i + "'required/></br>";
                               }
                               k =k+v+"<button type='submit' name='submitroom' onclick='valid(texte)' value=" + text + ">submit11</button></form>";
                               ...
                               function valid(inputtxt)
                               {
                                ...
                                if(inputtxt.value.match(cap))
                                {
                                  ...
                                  {
                                     //alert("capacity must be only integers") ;
                                     return false;
                                  }
                                }
                               ...
                               console.log(tex);
                               for (i = 0; i < tex; i++) {
                               k += "</br><label >room " + i + "</label><input type='text' name='texts" + i + "'required/></br>";
                               console.log(k);
                               }
                            ...
                            <form method="post">
                            <button type="submit" class="btn btn-info" name="showrooms" onclick="getdata();">Show available Rooms</button>
                            </form>
                            <form method="post">
...
//                               $conn = new mysqli($servername, $username, $password,"exam");
                             require('db.php');
                               ...
                               for( $i=0;$i < $k ;$i++)
                               {
                                  ...
                                  $res= mysqli_query($conn,$query);
                                    ?>
                                   <script>
                               alert("Room no:<?php echo $le ?> added succesfully");
                            </script>
                                <?php 
                            ...
                            <?php
                               for( $i=0;$i < $k ;$i++)
                               {
                                   ...
                                   $ls=$_POST["$l"];
                                   $sql="SELECT roomsid from `rooms`where roomsid='$ls' ";
                                   $res=mysqli_query($conn,$sql);
                                   if($res->num_rows==0){
                                    ?>
                                    <script>
                               alert("Room no:<?php echo $ls ?> not found");
                            </script>
                                  <?php }
                                  else{
                                   ...
                                   ?>
                                   <script>
                               alert("Room no:<?php echo $ls ?> deleted succesfully");
                            </script>
                               <?php
                              }
                               }
